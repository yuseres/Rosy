document.addEventListener('DOMContentLoaded', () => {
    ...
    const preloadTake = new Image();
    preloadTake.src = 'Takeit.jpg';
    const preloadNo = new Image();
    preloadNo.src = 'No.jpg';
    ...
    function openModal(imageSrc, altText) {
        ...
        modalImage.alt = altText || 'Surprise';
